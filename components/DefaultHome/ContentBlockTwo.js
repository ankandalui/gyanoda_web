...
const data = [
  {
    ...
    body: "You can easily download the Gyanoda app from the App Store or Google Play on any device",
  },
  {
    id: 2,
  ...
  {
    id: 3,
    title: "Choose a course & enjoy learning",
    body: "24/7 online access to a comprehensive collection of solved question papers",
  },
];
        ...
        <div className="row align-items-center">
          <div className="col-lg-6 col-xl-5 mt-5 mt-lg-0 order-2 order-lg-1">
            <div className="block-contents">
              ...
              >
                <h2>Take full control of your learning app</h2>
              </div>
            </div>
          ...
          <div className="col-lg-6 col-xl-6 offset-xl-1 pe-xl-3 col-12 order-1 order-lg-2">
            <div
              ...
              data-wow-delay=".3s"
            >
              <img src="img/home1/faq-img2.png" alt="" />
            </div>
          </div>
        </div>
      </div>
