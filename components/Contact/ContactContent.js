        ...
        <div className="row text-center">
          ...
          <div className="col-md-6 col-xl-4">
            <ContactCard
              icon={<FaEnvelope />}
              contentOne="Mail us"
              ContentTwo="support@gyanoda.com"
              className="box2"
            />
          </div>
          <div className="col-md-6 col-xl-4">
            <ContactCard
              icon={<FaMapMarkerAlt />}
              contentOne="218, Basudevpur Road Saratpally Shyamnagar, 743127"
              ContentTwo="P.O - Shyamnagar , North 24 pgs."
              className="box3"
            />
          </div>
        </div>
