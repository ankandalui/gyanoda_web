          ...
          <div className="col-xl-6 col-12 pe-xl-5 mt-5 mt-xl-0 order-2 order-xl-1">
            <div className="block-contents">
              ...
              <p
                ...
                data-wow-delay=".3s"
              >
                Xmoze is a simple software that allows you to run your business
                easily. One software tool brings the whole business together.
              </p>
              <ul className="checked-list">
                <li className="wow fadeInUp" data-wow-delay=".5s">
                  Calculate inputassets/ output results effortlessly
                </li>
                <li className="wow fadeInUp" data-wow-delay=".7s">
                  Prevent waste and increase income
                </li>
                <li className="wow fadeInUp" data-wow-delay=".9s">
                  Calculate stocks effortlessly & plan for the future
                </li>
              </ul>
              <a
                href="#"
                className="theme-btn second-color mt-40 wow fadeInUp"
                data-wow-duration="1s"
                data-wow-delay="1.1s"
              >
                Download Now
